...
import { storageRef, firestore } from '../properties/firestore';
//import { storageRef } from "../config/config";
// Update the image
const db = firestore.firestore();
export function uploadImage(data, name) {
    try {
                ...
                /*     uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                       //       dispatch({ type: UPLOADING_SUCCESS });
                         db
                              ...
                              .then(() => {
                                  //get the latest data
                                  //once the data is sent to the db the latest version is stored in the redux store
